...
import { getBiography, updateBiography } from '../services/biography-api';
...
const AlfManagement: React.FC = () => {
  ...
  const loadBiography = async () => {
    ...
    try {
      ...
      if (biography) {
        const data = {
          paragraph1_it: (biography as any).paragraph1_it || '',
          paragraph2_it: (biography as any).paragraph2_it || '',
          paragraph3_it: (biography as any).paragraph3_it || '',
          paragraph4_it: (biography as any).paragraph4_it || '',
          image_url: (biography as any).image_url || ''
        };
        setFormData(data);
      ...
      setToast({ message: 'Errore nel caricamento della biografia', type: 'error' });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setToast({ message: 'Biografia aggiornata con successo', type: 'success' });
      loadBiography();
    } catch (error) {
      console.error('Error updating biography:', error);
      setToast({ message: 'Errore nell\'aggiornamento della biografia', type: 'error' });
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <BackofficeLayout>
      <Helmet>
        <title>Gestione Biografia ALF - Backoffice</title>
      </Helmet>
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <h1 className="text-4xl font-bold text-white uppercase" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              Gestione <span style={{ color: 'rgb(240, 45, 110)' }}>Biografia ALF</span>
            </h1>
          </div>
        </div>
              ...
              >
                {formData.image_url ? (
                  ...
                  <div className="aspect-[3/4] flex flex-col items-center justify-center p-8">
                    ...
                    <p className="text-white/40 text-sm">Immagine della biografia</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex-1 space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Primo paragrafo della biografia..."
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-background text-white border rounded-lg focus:outline-none focus:border-pink-500 transition-colors resize-none"
                  style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}
                  placeholder="Secondo paragrafo della biografia..."
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-background text-white border rounded-lg focus:outline-none focus:border-pink-500 transition-colors resize-none"
                  style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}
                  placeholder="Terzo paragrafo della biografia..."
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-background text-white border rounded-lg focus:outline-none focus:border-pink-500 transition-colors resize-none"
                  style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}
                  placeholder="Quarto paragrafo della biografia..."
                />
              </div>
