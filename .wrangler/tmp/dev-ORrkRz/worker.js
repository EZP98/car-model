...
async function updateVersioning(db, tableName, entityId, translations) {
...
__name(updateVersioning, "updateVersioning");
  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (path.match(/^\/api\/collections\/\d+$/) && method === "PUT") {
        ...
        await updateVersioning(env.DB, "collections", result.id, body);
        await saveTranslations(env.DB, "collection", result.id, body);
        const enriched = await enrichWithTranslations(env.DB, [result], "collection");
        return jsonResponse({ collection: enriched[0] });
      }
      ...
      if (path.match(/^\/api\/exhibitions\/\d+$/) && method === "PUT") {
        ...
        await updateVersioning(env.DB, "exhibitions", result.id, body);
      ...
      if (path.match(/^\/api\/critics\/\d+$/) && method === "PUT") {
        ...
        await updateVersioning(env.DB, "critics", result.id, body);
        await saveTranslations(env.DB, "critic", result.id, body);
        const enriched = await enrichWithTranslations(env.DB, [result], "critic");
        return jsonResponse({ critic: enriched[0] });
      }
      ...
      if (path === "/api/biography" && method === "PUT") {
        ...
        const updates = [];
        const values = [];
        if (body.text_it !== void 0) {
          updates.push("text_it = ?");
          values.push(body.text_it);
        }
        if (body.text_en !== void 0) {
          updates.push("text_en = ?");
          values.push(body.text_en);
        }
        if (body.text_es !== void 0) {
          updates.push("text_es = ?");
          values.push(body.text_es);
        }
        if (body.text_fr !== void 0) {
          updates.push("text_fr = ?");
          values.push(body.text_fr);
        }
        if (body.text_ja !== void 0) {
          updates.push("text_ja = ?");
          values.push(body.text_ja);
        }
        if (body.text_zh !== void 0) {
          updates.push("text_zh = ?");
          values.push(body.text_zh);
        }
        if (body.text_zh_tw !== void 0) {
          updates.push("text_zh_tw = ?");
          values.push(body.text_zh_tw);
        }
        if (updates.length === 0) {
          return jsonResponse({ error: "No fields to update" }, 400);
        }
      ...
      if (path === "/api/parallax" && method === "PUT") {
        ...
        if (body.text_top_it !== void 0) {
          updates.push("text_top_it = ?");
          values.push(body.text_top_it);
        }
        if (body.text_top_en !== void 0) {
          updates.push("text_top_en = ?");
          values.push(body.text_top_en);
        }
        if (body.text_top_es !== void 0) {
          updates.push("text_top_es = ?");
          values.push(body.text_top_es);
        }
        if (body.text_top_fr !== void 0) {
          updates.push("text_top_fr = ?");
          values.push(body.text_top_fr);
        }
        if (body.text_top_ja !== void 0) {
          updates.push("text_top_ja = ?");
          values.push(body.text_top_ja);
        }
        if (body.text_top_zh !== void 0) {
          updates.push("text_top_zh = ?");
          values.push(body.text_top_zh);
        }
        if (body.text_top_zh_tw !== void 0) {
          updates.push("text_top_zh_tw = ?");
          values.push(body.text_top_zh_tw);
        }
        if (body.text_bottom_it !== void 0) {
          updates.push("text_bottom_it = ?");
          values.push(body.text_bottom_it);
        }
        if (body.text_bottom_en !== void 0) {
          updates.push("text_bottom_en = ?");
          values.push(body.text_bottom_en);
        }
        if (body.text_bottom_es !== void 0) {
          updates.push("text_bottom_es = ?");
          values.push(body.text_bottom_es);
        }
        if (body.text_bottom_fr !== void 0) {
          updates.push("text_bottom_fr = ?");
          values.push(body.text_bottom_fr);
        }
        if (body.text_bottom_ja !== void 0) {
          updates.push("text_bottom_ja = ?");
          values.push(body.text_bottom_ja);
        }
        if (body.text_bottom_zh !== void 0) {
          updates.push("text_bottom_zh = ?");
          values.push(body.text_bottom_zh);
        }
        if (body.text_bottom_zh_tw !== void 0) {
          updates.push("text_bottom_zh_tw = ?");
          values.push(body.text_bottom_zh_tw);
        }
        if (updates.length === 0) {
          return jsonResponse({ error: "No fields to update" }, 400);
        }
...
// .wrangler/tmp/bundle-6tE4qv/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-6tE4qv/middleware-loader.entry.ts
